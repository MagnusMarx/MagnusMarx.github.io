    ...
    Dosbox.prototype.run = function(archiveUrl, executable) {
      return new Dosbox.Mount(this.module, archiveUrl, {
        success: (function(_this) {
          return function() {
            var func, hide;
            _this.ui.updateMessage("Launching STRIFE.WAD");
            hide = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Reading STRIFE.WAD " + Strife.wad + " (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
      ...
      return new Dosbox.Xhr('https://js-dos.com/cdn/js-dos-v3.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('Launching IWADS');
            func = function() {
