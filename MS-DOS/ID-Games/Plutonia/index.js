...
(function() {
  this.Dosbox = (function() {
    ...
    Dosbox.prototype.run = function(archiveUrl, executable) {
      return new Dosbox.Mount(this.module, archiveUrl, {
        success: (function(_this) {
          return function() {
            var func, hide;
            _this.ui.updateMessage("Launching Plutonia.WAD");
            hide = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Reading Plutonia.WAD " + Plutonia.wad + " (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
    ...
    Dosbox.prototype.downloadScript = function() {
      this.module.setStatus('Searching for PWADS');
      this.ui.updateMessage('Reading IWADS');
      return new Dosbox.Xhr('https://js-dos.com/cdn/js-dos-v3.js', {
        success: (function(_this) {
          return function(script) {
            var func;
            _this.ui.updateMessage('Searching for IWADS');
            func = function() {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Downloading DOS IWAD Executable (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
