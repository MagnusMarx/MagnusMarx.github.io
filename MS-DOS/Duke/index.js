...
(function() {
  this.Dosbox = (function() {
      ...
      return new Dosbox.Mount(this.module, archiveUrl, {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Executing " + executable + " (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
    ...
    Dosbox.prototype.downloadScript = function() {
      this.module.setStatus('Uploading Files');
      this.ui.updateMessage('Opening executable');
      return new Dosbox.Xhr('https://js-dos.com/cdn/js-dos-v3.js', {
        ...
        progress: (function(_this) {
          return function(total, current) {
            return _this.ui.updateMessage("Waiting for MS-DOS to respond... (" + (current * 100 / total | 0) + "%)");
          };
        })(this)
      });
    };
...
(function() {
  Dosbox.UI = (function() {
    function UI(options) {
      ...
      this.overlay.append($('<div class="dosbox-powered">Ported By &nbsp;').append($('<a href="https://adamtrex.azurewebsites.net/index.html">Magnus Marks')));
